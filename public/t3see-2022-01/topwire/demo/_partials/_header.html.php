...
<head>
    ...
    <link href="styles/home.css" rel="stylesheet" crossorigin="anonymous">
    <?php if (($_GET['context'] ?? '') === 'drive'): ?>
        <link href="styles/drive.css" rel="stylesheet" crossorigin="anonymous">
    <?php endif; ?>
    <?php if (($_GET['context'] ?? '') === 'frames'): ?>
        <link href="styles/frames.css" rel="stylesheet" crossorigin="anonymous">
    <?php endif; ?>
</head>
<body class="bg-body">
...
<div class="container">
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
        <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
            ...
            <span class="fs-4">Hotwire Basics</span>
        </a>
        ...
        <ul class="nav nav-pills">
            ...
            <li class="nav-item"><a href="/t3see-2022-01/topwire/demo/about.php?context=about" class="nav-link">About</a></li>
        </ul>
    </header>
</div>
